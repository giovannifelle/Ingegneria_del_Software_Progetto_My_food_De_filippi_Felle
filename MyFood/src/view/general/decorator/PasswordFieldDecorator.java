...
public class PasswordFieldDecorator extends JPasswordField {
    private final int arcWidth;
    private final int arcHeight;

    public PasswordFieldDecorator(JPasswordField passwordField, int arcWidth, int arcHeight) {
        super(passwordField.getColumns());
